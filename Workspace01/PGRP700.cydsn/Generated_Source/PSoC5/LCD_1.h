...
#define LCD_1_TXBUFFERSIZE                   (4u)
#define LCD_1_RXBUFFERSIZE                   (20u)
...
#define LCD_1_BIT_CENTER                         (LCD_1_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 LCD_1_initVar;
    ...
    extern volatile uint8 LCD_1_txBuffer[LCD_1_TXBUFFERSIZE];
    extern volatile uint8 LCD_1_txBufferRead;
    extern uint8 LCD_1_txBufferWrite;
#endif /* End LCD_1_TX_ENABLED */
#if( ( LCD_1_RX_ENABLED || LCD_1_HD_ENABLED ) && \
     (LCD_1_RXBUFFERSIZE > LCD_1_FIFO_LENGTH) )
    extern volatile uint8 LCD_1_rxBuffer[LCD_1_RXBUFFERSIZE];
...
#if (LCD_1_RXHW_ADDRESS_ENABLED)
    #define LCD_1_RXADDRESSMODE      (0u)
    #define LCD_1_RXHWADDRESS1       (0u)
    #define LCD_1_RXHWADDRESS2       (0u)
