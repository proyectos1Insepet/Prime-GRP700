...
#define Bootloader_1_WAIT_FOR_COMMAND_TIME      (50u)
...
*******************************************************************************/
#define Bootloader_1_GET_BTLDB_CHECKSUM         (1u)
#define Bootloader_1_GET_BTLDB_ADDR             (2u)
#define Bootloader_1_GET_BTLDR_LAST_ROW         (3u)
#define Bootloader_1_GET_BTLDB_LENGTH           (4u)
#define Bootloader_1_GET_BTLDB_ACTIVE           (5u)
#define Bootloader_1_GET_BTLDB_STATUS           (6u)
#define Bootloader_1_GET_BTLDR_APP_VERSION      (7u)
#define Bootloader_1_GET_BTLDB_APP_VERSION      (8u)
#define Bootloader_1_GET_BTLDB_APP_ID           (9u)
#define Bootloader_1_GET_BTLDB_APP_CUST_ID      (10u)
